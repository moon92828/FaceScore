...
public class AlbumGridViewAdapter extends BaseAdapter {
    ...
    private ArrayList<ImageInfo> selectedDataList;
    private DisplayMetrics dm;
    BitmapCache cache;

    public AlbumGridViewAdapter(Context c, ArrayList<ImageInfo> dataList,
                                ArrayList<ImageInfo> selectedDataList) {
        mContext = c;
...
//					path, Res.getDrawableID("plugin_camera_camera_default"), 100, 100);
            final ImageInfo item = dataList.get(position);
