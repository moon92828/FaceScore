...
import demo.ui.AlbumActivity;
import demo.ui.ShowAllPhotoActivity;
import demo.util.BitmapCache;
import demo.util.Res;
import demo.util.BitmapCache.ImageCallback;
...
//			holder.imageView.setImageBitmap( AlbumActivity.contentList.get(position).imageList.get(0).getBitmap());
            final ImageInfo item = AlbumActivity.contentList.get(position).imageList.get(0);
    ...
    private class ImageViewClickListener implements OnClickListener {
        ...
        public void onClick(View v) {
            ShowAllPhotoActivity.dataList = (ArrayList<ImageInfo>) AlbumActivity.contentList.get(position).imageList;
