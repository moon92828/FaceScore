...
import demo.R;
import demo.adapter.AlbumGridViewAdapter;
import demo.info.ImageInfo;
import demo.util.AlbumHelper;
import demo.util.Bimp;
import demo.util.ImageBucket;
...
public class AlbumActivity extends BaseActivity {
    ...
    private void init() {
        ...
        dataList = new ArrayList<ImageInfo>();
    ...
    private boolean removeOneData(ImageInfo imageItem) {
